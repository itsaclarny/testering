local library = {
  ...
  local Themes = {
    Purple = {
        ...
        Secondary = Color3.fromRGB(45, 38, 52),
        Tertiary = Color3.fromRGB(75, 65, 85),
        Divider = Color3.fromRGB(50, 43, 58),
        AccentDivider = Color3.fromRGB(60, 52, 70),
        PrimaryText = Color3.fromRGB(220, 215, 230),
        SecondaryText = Color3.fromRGB(140, 130, 150),
        TertiaryText = Color3.fromRGB(170, 160, 180),
        Hovering = Color3.fromRGB(60, 52, 70),
        Accent = Color3.fromRGB(150, 100, 220),
        DarkerAccent = Color3.fromRGB(120, 80, 180),
        AccentText = Color3.fromRGB(240, 235, 250),
        WindowGradient1 = Color3.fromRGB(30, 25, 35),
        WindowGradient2 = Color3.fromRGB(15, 12, 18)
    },
    Blue = {
        Primary = Color3.fromRGB(25, 28, 35),
        Secondary = Color3.fromRGB(38, 42, 52),
        Tertiary = Color3.fromRGB(65, 72, 85),
        Divider = Color3.fromRGB(43, 48, 58),
        AccentDivider = Color3.fromRGB(52, 58, 70),
        PrimaryText = Color3.fromRGB(215, 220, 230),
        SecondaryText = Color3.fromRGB(130, 140, 150),
        TertiaryText = Color3.fromRGB(160, 170, 180),
        Hovering = Color3.fromRGB(52, 58, 70),
        Accent = Color3.fromRGB(70, 130, 220),
        DarkerAccent = Color3.fromRGB(55, 105, 180),
        AccentText = Color3.fromRGB(235, 240, 250),
        WindowGradient1 = Color3.fromRGB(25, 28, 35),
        WindowGradient2 = Color3.fromRGB(12, 14, 18)
    },
    Green = {
        Primary = Color3.fromRGB(25, 35, 28),
        Secondary = Color3.fromRGB(38, 52, 42),
        Tertiary = Color3.fromRGB(65, 85, 72),
        Divider = Color3.fromRGB(43, 58, 48),
        AccentDivider = Color3.fromRGB(52, 70, 58),
        PrimaryText = Color3.fromRGB(215, 230, 220),
        SecondaryText = Color3.fromRGB(130, 150, 140),
        TertiaryText = Color3.fromRGB(160, 180, 170),
        Hovering = Color3.fromRGB(52, 70, 58),
        Accent = Color3.fromRGB(100, 190, 31),
        DarkerAccent = Color3.fromRGB(87, 167, 26),
        AccentText = Color3.fromRGB(235, 250, 235),
        WindowGradient1 = Color3.fromRGB(25, 35, 28),
        WindowGradient2 = Color3.fromRGB(12, 18, 14)
    },
    Red = {
        Primary = Color3.fromRGB(35, 25, 25),
        Secondary = Color3.fromRGB(52, 38, 38),
        Tertiary = Color3.fromRGB(85, 65, 65),
        Divider = Color3.fromRGB(58, 43, 43),
        AccentDivider = Color3.fromRGB(70, 52, 52),
        PrimaryText = Color3.fromRGB(230, 215, 215),
        SecondaryText = Color3.fromRGB(150, 130, 130),
        TertiaryText = Color3.fromRGB(180, 160, 160),
        Hovering = Color3.fromRGB(70, 52, 52),
        Accent = Color3.fromRGB(220, 70, 70),
        DarkerAccent = Color3.fromRGB(180, 55, 55),
        AccentText = Color3.fromRGB(250, 235, 235),
        WindowGradient1 = Color3.fromRGB(35, 25, 25),
        WindowGradient2 = Color3.fromRGB(18, 12, 12)
    },
    Orange = {
        Primary = Color3.fromRGB(35, 28, 25),
        Secondary = Color3.fromRGB(52, 42, 38),
        Tertiary = Color3.fromRGB(85, 72, 65),
        Divider = Color3.fromRGB(58, 48, 43),
        AccentDivider = Color3.fromRGB(70, 58, 52),
        PrimaryText = Color3.fromRGB(230, 220, 215),
        SecondaryText = Color3.fromRGB(150, 140, 130),
        TertiaryText = Color3.fromRGB(180, 170, 160),
        Hovering = Color3.fromRGB(70, 58, 52),
        Accent = Color3.fromRGB(230, 140, 70),
        DarkerAccent = Color3.fromRGB(190, 115, 55),
        AccentText = Color3.fromRGB(250, 240, 235),
        WindowGradient1 = Color3.fromRGB(35, 28, 25),
        WindowGradient2 = Color3.fromRGB(18, 14, 12)
    }
  }
  ...
  function library:SetTheme(themeName)
    if Themes[themeName] then
        ...
        if self.Window then
            ...
            Window.Main.UIGradient.Color = ColorSequence.new({
                ColorSequenceKeypoint.new(0, Colors.WindowGradient1),
  ...
  -- Theme Container (below GUI)
  local ThemeContainer = Utilities:Create("Frame", {
      Name = "ThemeContainer",
      Size = UDim2.new(0, 600, 0, 25),
      Position = UDim2.new(0, 600, 0, 672),
  ...
  ThemeContainer.Parent = Window
  
  -- Create theme buttons
  for themeName, _ in pairs(Themes) do
      local ThemeButton = Utilities:Create("TextButton", {
          Name = themeName,
          Text = themeName,
          Size = UDim2.new(0, 70, 1, 0),
          BackgroundColor3 = themeName == CurrentTheme and Colors.Accent or Colors.Secondary,
          TextColor3 = themeName == CurrentTheme and Colors.AccentText or Colors.PrimaryText,
          Font = Enum.Font.SourceSansBold,
          TextSize = 12,
          ZIndex = DropIndex + 12,
      ...
      ThemeButton.MouseEnter:Connect(function()
          if themeName ~= CurrentTheme then
              Utilities:Tween(ThemeButton, .125, {BackgroundColor3 = Colors.Hovering})
          end
      end)
      
      ThemeButton.MouseLeave:Connect(function()
          if themeName ~= CurrentTheme then
              Utilities:Tween(ThemeButton, .125, {BackgroundColor3 = Colors.Secondary})
          end
      end)
  ...
  UserInputService.InputBegan:Connect(function(Input, GameProcessed)
    if Input.KeyCode == Enum.KeyCode.LeftAlt and not GameProcessed then
        ...
        ThemeContainer.Visible = Window.Main.Visible
    end
  end)
  ...
  local function Resize()
    ...
    Utilities:Tween(ThemeContainer, .05, {Size = UDim2.new(0, X, 0, 25)})
    Utilities:Tween(ThemeContainer, .05, {Position = UDim2.new(0, Window.Main.AbsolutePosition.X, 0, Window.Main.AbsolutePosition.Y + Y + 2)})
  ...
  UserInputService.InputChanged:Connect(function(input)
      if input == dragInput and dragging then
          ...
          ThemeContainer.Position = UDim2.new(0, Window.Main.AbsolutePosition.X, 0, Window.Main.AbsolutePosition.Y + Window.Main.AbsoluteSize.Y + 2)
      end
  end)
  
  function WindowTable:Exit()
      ThemeContainer:Destroy()
      Window:Destroy()
  end
  
  function WindowTable:Toggle()
      Window.Enabled = not Window.Enabled
      ThemeContainer.Visible = Window.Enabled
  end
